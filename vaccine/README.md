...
is used to represent the following:
   ...
   `td_date` <br />
   `varicella` Varicella vaccine<br />
   `varicella_date`<br />
   ...
   `mmvr` Measles, mumps, rubella, and varicellaicella vaccines<br />
   `mmvr_date` <br />

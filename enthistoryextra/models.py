...
# this model used to add history found in an ENT exam not accounted for in
...
class ENTHistoryExtra(models.Model):
    ...
    side = models.CharField(max_length = 1, choices = ENTHistory.EAR_SIDE_CHOICES, default = ENTHistory.EAR_SIDE_BOTH)
